...
export default function EmpleadoNominaCard({ empleado, canManage, onSave }: EmpleadoNominaCardProps) {
  ...
  return (
    <div className={`
      ...
      border border-neutral-200/60 dark:border-neutral-800/40
      ${isEditing ? 'shadow-lg scale-[1.01] border-emerald-200/60 dark:border-emerald-900/40' : 'shadow-sm hover:shadow-md'}
    `}>
