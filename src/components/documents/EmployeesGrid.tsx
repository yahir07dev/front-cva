      ...
      <div className="relative max-w-3xl mx-auto group">
        ...
        <input
          ...
          className="
            ...
            text-sm font-medium text-neutral-900 dark:text-white placeholder:text-neutral-500
        ...
        {filteredEmpleados.length === 0 ? (
          ...
          filteredEmpleados.map((empleado) => (
            <Link
              ...
              "
            >
              {/* Badge de Documento Superior Derecho (Ya no tapa el nombre) */}
              <div className="
                absolute top-5 right-5 p-2.5 rounded-2xl 
                bg-cyan-50 dark:bg-cyan-500/10 text-cyan-600 dark:text-cyan-400
                border border-cyan-100 dark:border-cyan-500/20 shadow-sm
              ...
              <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-32 h-32 bg-cyan-500/20 blur-[50px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
                ...
                ">
                  {empleado.foto_perfil_url ? (
                    ...
                    <div className="h-full w-full flex items-center justify-center">
                      <User className="w-10 h-10 text-cyan-600/50 dark:text-cyan-400/50" />
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="
                w-full pt-5 mt-auto border-t border-neutral-200/50 dark:border-neutral-800/50 
