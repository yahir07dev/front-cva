...
export default function EditEmpleadoPage() {
  ...
  // --- ESTILOS ADAPTADOS A TU DISEÑO GLASSMORPHISM ---
  const inputStyle =
  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-6 pb-20 animate-in fade-in duration-500">
      ...
      {/* HEADER TIPO GLASSMORPHISM (como en ActividadesHeader) */}
      <header className="
        w-full bg-white/70 dark:bg-neutral-900/70 backdrop-blur-xl 
        border border-neutral-200/30 dark:border-neutral-800/50 
        rounded-[32px] p-6 md:p-8 shadow-sm
      ">
      ...
      >
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <section className="bg-white/40 dark:bg-white/[0.02] backdrop-blur-md rounded-[32px] p-6 md:p-8 border border-neutral-200/50 dark:border-0 shadow-sm hover:shadow-md transition-shadow">
