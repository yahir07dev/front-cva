              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 bg-[#2a2a2a] border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 text-white placeholder-gray-500"
                    placeholder="••••••••••"
                    required
                  />
                  <button
