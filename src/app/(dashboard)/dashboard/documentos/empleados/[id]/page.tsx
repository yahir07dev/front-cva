...
export default function DetalleExpedientePage() {
  ...
  if (loading)
    return (
      <div className="flex h-[60vh] items-center justify-center w-full animate-in fade-in duration-500">
  ...
  return (
    // CAMBIO 1: El contenedor padre ahora maneja h-full, flex, flex-col y min-h-0 para permitir el scroll interno
    <div className="w-full h-full flex flex-col min-h-0 space-y-8 pb-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      
      {/* 1. HEADER HERO (Glassmorphism + Progress) */}
      {/* CAMBIO 2: Agregamos shrink-0 para que el header no se aplaste al hacer scroll hacia abajo */}
      <header className="
        shrink-0 relative overflow-hidden w-full bg-white/70 dark:bg-neutral-900/70 backdrop-blur-xl 
        border border-neutral-200/50 dark:border-neutral-800/50 
        rounded-[32px] p-6 md:p-10 shadow-sm
      ">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div className="relative shrink-0">
              <div className="
                ...
                bg-gradient-to-br from-cyan-50 to-neutral-100 dark:from-cyan-950/40 dark:to-neutral-900 
                ring-4 ring-white dark:ring-neutral-950 shadow-lg
              ">
      ...
      {/* 2. GRID DE DOCUMENTOS CON SCROLL */}
      {/* CAMBIO 3: flex-1 min-h-0 le da la altura restante, overflow-y-auto habilita el scroll, y agregamos las clases del scrollbar */}
            ...
            return (
              <div
                ...
                className="
                  ...
                  border border-neutral-200/50 dark:border-neutral-800/50 
                  rounded-[28px] overflow-hidden shadow-sm hover:shadow-xl 
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className={`
                      p-3 sm:p-3.5 rounded-2xl transition-colors duration-300
                      ${doc 
                ...
                <div className="w-full pt-4 mt-auto border-t border-neutral-100/80 dark:border-neutral-800/80 flex items-center justify-between">
                  ...
                  <label className={`
                    flex items-center justify-center gap-2 cursor-pointer px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl text-[10px] sm:text-xs font-bold uppercase tracking-widest transition-all active:scale-95 shadow-md
                    ${doc
                      ? "bg-neutral-900 dark:bg-white text-white dark:text-black hover:scale-105"
                      : "bg-cyan-600 text-white hover:bg-cyan-700 shadow-cyan-600/20 hover:scale-105"
                    }
                  `}>
                    {isUploading ? (
